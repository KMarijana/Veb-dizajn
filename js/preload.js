$(document).ready(function () {
  ...
  function loading() {
    ...
    window.requestAnimFrame(loading);
  }
  loading();
  ...
  setTimeout(function () {
    $("body > .canvas-wrapper > .container-preloader")
      .css("display", "flex")
      .hide()
      .fadeIn();
  ...
  $("body > .canvas-wrapper > .container-preloader > .pulse-button").click(function () {
    $('body >.canvas-wrapper').toggle(1000);
    continueAnimating = false;
    setTimeout(function () {
      $('body > .canvas-wrapper').remove();
